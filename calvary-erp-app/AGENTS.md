...
These guidelines apply to both the back‑end (calvary-erp‑app) and the front‑end (calvary-erp‑client) projects that are generated with JHipster. They are intended to harmonise how we write code, document our work and verify that the system meets the expectations of both developers and end‑users.

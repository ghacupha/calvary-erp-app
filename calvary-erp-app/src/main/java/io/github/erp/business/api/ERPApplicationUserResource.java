 ...
 */
@RestController
@RequestMapping("/api/erp/application-users")
public class ERPApplicationUserResource {

    private static final Logger LOG = LoggerFactory.getLogger(ERPApplicationUserResource.class);
    ...
    public ERPApplicationUserResource(

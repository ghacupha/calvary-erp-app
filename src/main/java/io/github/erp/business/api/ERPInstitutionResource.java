 ...
 */
@RestController
@RequestMapping("/api/erp/institutions")
public class ERPInstitutionResource {

    private static final Logger LOG = LoggerFactory.getLogger(ERPInstitutionResource.class);

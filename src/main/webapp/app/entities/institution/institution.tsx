...
import { getEntities, searchEntities } from './institution.reducer';
...
export const Institution = () => {
  ...
  const totalItems = useAppSelector(state => state.institution.totalItems);
  ...
  return (
    <div>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('institutionName')}>
                  Institution Name <FontAwesomeIcon icon={getSortIconByFieldName('institutionName')} />
                </th>
                <th>
                  Parent Institution <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {institution.parentInstitution ? (
                      <Link to={`/institution/${institution.parentInstitution.id}`}>{institution.parentInstitution.institutionName}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/institution/${institution.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/institution/${institution.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={institutionList && institutionList.length > 0 ? '' : 'd-none'}>

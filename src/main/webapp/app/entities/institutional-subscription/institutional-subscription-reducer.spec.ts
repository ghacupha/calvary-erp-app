...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './institutional-subscription.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTITUTIONALSUBSCRIPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INSTITUTIONALSUBSCRIPTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTITUTIONALSUBSCRIPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTITUTIONALSUBSCRIPTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSTITUTIONALSUBSCRIPTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTITUTIONALSUBSCRIPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTITUTIONALSUBSCRIPTION actions', async () => {
      const arg = 42666;
